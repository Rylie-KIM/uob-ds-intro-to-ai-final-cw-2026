...
│   │   └── type_a_llm_*.csv                    ← LLM prediction results
│   │
...
│   │
│   ├── data/                                   ← generated data CSVs (images gitignored)
│   │   ├── type-a/
│   │   │   ├── master.csv
│   │   │   ├── sentences_a.csv
│   │   │   └── dataloader.py
...
│   │       ├── precompute_embeddings.py        ← run once to generate all .pt files
│   │       ├── type-a/
...
│   │                   ├── llm/                ← LLM-specific plots
│   │                   ├── normalised/
│   │                   ├── comparison/         ← cross-variant comparison
│   │                   ├── combined/           ← Stage 1 + 2 + LLM summary
│   │                   └── s2/
│   │                       ├── normalised/
│   │                       └── non-normalised/
│   │
│   ├── type-b/                                 ← top-level Type-B pipeline entry point
│   │   └── pipeline_b.py
│   │
...
│       └── type-c/
│
├── report/                                     ← LaTeX report (git submodule)
│   ├── README.md
│   ├── latex/
...
│
├── docs/                                       ← generated rationale documents (.md / .docx)
│
├── .claude/                                    ← Claude Code configuration
│   ├── CLAUDE.md
│   └── task-plan/                              ← design docs and mathematical rationale
│       ├── task_plan_tracker.md
│       ├── dim_rationale.md
│       ├── loss_metric_rationale.md
│       ├── experiment_design.md
│       ├── performance_metrics.md
│       └── tf-idf_lsa.md
│
├── .gitmodules                                 ← report submodule pointer
├── .gitignore
├── .env.example
├── requirements.txt
└── README.md
