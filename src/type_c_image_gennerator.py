...
def generate_images_from_dataset(
    dataset_file: str = os.path.normpath(os.path.join(BASE_DIR, "../../data/type-c/sentences_c.csv")),
    image_dir: str = os.path.normpath(os.path.join(BASE_DIR, "../../data/images/type-c")),
    map_file: str = os.path.normpath(os.path.join(BASE_DIR, "../../data/type-c/image_map_c.csv")),
    image_size: int = 500
) -> None:
    ...
    with open(map_file, "w", newline="", encoding="utf-8") as f:
        writer = csv.DictWriter(f, fieldnames=["id", "image", "notation"])
        writer.writeheader()
        writer.writerows(image_map_rows)
